...
dta <- read_csv("Data/200422COVID19MEXICO.csv")
...
#dta.grp <- dta_split$Nacional

#kk <- dta.grp %>% mutate("FALLECIO" = ifelse(is.na(`FECHA_DEF`), "No", "Si"),
#                         "TIEMPO_ATENCION" = 
#                           `FECHA_INGRESO` - `FECHA_SINTOMAS`,
#                         "Diasparadeceso" = `FECHA_DEF` - `FECHA_INGRESO`) %>%
