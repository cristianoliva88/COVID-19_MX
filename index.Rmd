...
dta <- read_csv("Data/200425COVID19MEXICO.csv")
...
#  kk2 <- left_join(dta.blank.compstate, kk, by=c("FECHA_INGRESO", "grp"))
#}
...
tblkk <- dta_comb %>% group_by(`grp`, `FECHA_DEF`) %>%
          summarise("Decesos x dia" =  sum( `FECHA_DEF` == `FECHA_INGRESO` & 
                                  `RESULTADO` == "Positivo SARS-CoV-2") )
