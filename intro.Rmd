...
cat(paste("## Gráfica de Casos Positivos Intubados y en UCI \n\n"))
cat("\n\n")
...
cat("La tasa de Positividad al día d está calculada de acuerdo a la fórmula 
    ...
    $$ \\text{Tasa Mortalidad al día d} = \\frac{\\text{decesos al día d}}{\\text{casos positivos al día d}}.$$ 
    **Importante:** dado que los casos positivos son obtenidos mediante un muestreo de la población de casos sospechosos, la tasa de mortalidad es en realidad menor a la calculada. \n\n")
