...
for(x in grp_names){
  ...
  plot.posnew[[x]] <- tbl.resultado[[x]] %>%
                      ggplot(aes(x = `FECHA_INGRESO`, y = `Nuevos Positivo`)) +
                        ...
                        geom_point(aes(text = paste(`Nuevos Positivo`, 
                            'casos en', format(`FECHA_INGRESO`, "%d/%m"))), 
                                color = "darkblue") + 
                        theme_bw() +
  ...
  ## Plot of suspect cases by day
  plot.sospnew[[x]] <- tbl.resultado[[x]] %>%
                      ggplot(aes(x = `FECHA_INGRESO`, y = `Sospechosos`)) +
                        geom_line(color = "darkblue") + 
                        geom_point(aes(text = paste(`Sospechosos`, 
                            'casos en', format(`FECHA_INGRESO`, "%d/%m"))), 
                                color = "darkblue") + 
                        theme_bw() +
                        xlab("Fecha de Ingreso") + 
                        ylab("Casos Sospechosos")
  
  ## Plot of total suspect cases
    plot.sosptotal[[x]] <- tbl.resultado[[x]] %>%
                    ggplot(aes(x = `FECHA_INGRESO`, y = `Total Sospechosos`)) +
                        geom_line(color = "darkblue") + 
                        geom_point(aes(text = paste(`Total Sospechosos`, 
                              'casos en', format(`FECHA_INGRESO`, "%d/%m"))), 
                                color = "darkblue") + 
                        theme_bw() +
                        xlab("Fecha de Ingreso") + 
                        ylab("Total Casos Sospechosos")    
